...
import { gluten } from '../../lib/language'
import Image from 'next/image'
import HeroImg from '../../assets/Hero-image.jpeg'

const Hero: React.FC<any> = () => {
    return (
        <section className='bg-black mt-24 h-[calc(100vh-4rem)] flex flex-1 gap-x-4 flex-col sm:flex-row items-center justify-evenly sm:justify-between'>
            <div className='flex flex-col justify-start'>
                <div className='text-xl text-white font-extrabold tracking-wider leading-loose'>
            ...
            <div className='p-8 w-3/4 sm:w-1/2'>
